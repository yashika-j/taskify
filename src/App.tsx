...
const url: string= "https://images.unsplash.com/photo-1578897367107-2828e351c8a8?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGdpcmwlMjBiYWJ5fGVufDB8fDB8fHww"
function App(): JSX.Element {
  const [task, setTask] = useState<string>("")
  const [user, setUser] = useState<userInfo>({name:"yashika", pic:url,userId:"123"} as userInfo)
